...
| :-------- | :---------- | :--- | :--- | :-------- | :-------- |
| 1 초      | 256 MB      | 8268 | 2026 | 1340      | 23.076%   |
...
<div align=center>
  <img src="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/13414/B1.png" width="546" height="194" />
</div>
...
| 예제 입력1                                                                                                  | 예제 출력1                         |
| :---------------------------------------------------------------------------------------------------------- | :--------------------------------- |
| 3 8<br/>20103324<br/>20133221<br/>20133221<br/>20093778<br/>20140101<br/>01234567<br/>20093778<br/>20103325 | 20103324<br/>20133221<br/>20140101 |
...
### 문제 접근
  ...
  - 학번을 `key`, 순서를 `value`로 하여 `map`에 원소를 넣음

    - 동일한 키값이 등장하면 가장 나중에 등장한 순서를 넣음

  - `value`를 기준으로 정렬한 후, `K`개의 학번을 앞에서부터 출력

    - 단, 제한 인원보다 수강 인원이 적은 경우 고려해야 함