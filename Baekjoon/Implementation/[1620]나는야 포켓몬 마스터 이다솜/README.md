...
| :-------- | :---------- | :---- | :--- | :-------- | :-------- |
| 2 초      | 256 MB      | 29249 | 9769 | 6965      | 32.849%   |

</div>

### 문제

<img src="https://www.acmicpc.net/upload/201004/p1.PNG" width="274" height="184"/>
...
<img src="https://www.acmicpc.net/upload/201004/p2.PNG" width="274" height="184"/>
...
<img src="https://www.acmicpc.net/upload/201004/p3.PNG" width="274" height="184"/>

오영식 : 어? 오박사님 얘는 누구인가요?

<img src="https://www.acmicpc.net/upload/201004/p4.PNG" width="274" height="184"/>
...
<img src="https://www.acmicpc.net/upload/201004/p5.PNG" width="274" height="184"/>

이다솜 : 피카츄 공격!

<img src="https://www.acmicpc.net/upload/201004/p6.PNG" width="274" height="184"/>

가라 몬스터 볼!

<img src="https://www.acmicpc.net/upload/201004/p7.PNG" width="274" height="184"/>

이다솜 : 야호! 신난다. 꼬렛을 잡았다!!!!!

이다솜 : 그럼! 일단 사천왕을 이기고 오겠어!

<img src="https://www.acmicpc.net/upload/201004/p8.PNG" width="274" height="184"/>

이다솜 : 여기가 사천왕과 대결하려면 가야하는 곳인가..

<img src="https://www.acmicpc.net/upload/201004/p9.PNG" width="274" height="184"/>
...
<img src="https://www.acmicpc.net/upload/201004/pa.PNG" width="274" height="184"/>

오영식 : 훗. 1년 전의 그 이다솜이 사천왕을 이기고 현재 포켓몬 마스터인 나에게 덤벼? 어디 한번 덤벼보시지.

이다솜 : 헐랭... 나를 우습게보네.... 한번 두고 보시지! 그럼 대결이닷!

<img src="https://www.acmicpc.net/upload/201004/pb.PNG" width="274" height="184"/>

<img src="https://www.acmicpc.net/upload/201004/pc.PNG" width="274" height="184"/>

<img src="https://www.acmicpc.net/upload/201004/pd.PNG" width="274" height="184"/>

<img src="https://www.acmicpc.net/upload/201004/pe.PNG" width="274" height="184"/>

<img src="https://www.acmicpc.net/upload/201004/pf.PNG" width="274" height="184"/>

<img src="https://www.acmicpc.net/upload/201004/pg.PNG" width="274" height="184"/>

<img src="https://www.acmicpc.net/upload/201004/ph.PNG" width="274" height="184"/>

<img src="https://www.acmicpc.net/upload/201004/pi.PNG" width="274" height="184"/>
...
<img src="https://www.acmicpc.net/upload/201004/pn.PNG" width="141" height="122" />
...
### 문제 접근
  ...
  - 문제가 길지만 간단하게 `map`을 사용하는 문제

  - `string`을 `key`로하는 `map`과 `int`를 `key`로하는 `map`, 두 개의 `map` 사용

  - 입력받은 `N`개의 문자열로 2개의 `map` 초기화

  - `M`개 만큼의 문자열을 입력받고, 첫 문자를 이용해 입력 문자열이 숫자인 경우에는 `num_pocket`을 이용해 포켓몬의 이름을 찾고, 문자인 경우에는 `name_pocket`을 이용해 포켓몬의 번호를 찾음