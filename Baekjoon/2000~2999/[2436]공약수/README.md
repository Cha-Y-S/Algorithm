...
| :-------: | :---------: | :---: | :---: | :-------: | :-------: |
|   1 초    |   128 MB    | 8677  | 2264  |   1705    |  26.838%  |
...
| 예제 입력2 | 예제 출력2  |
| :--------: | :---------: |
| 2 86486400 | 11648 14850 |

---

### 문제 접근

  - `LCM = (a * b) / GCD` -> `a * b = LCM * GCD`

  - 위의 식에서 해당 조건을 만족하는 `a`, `b`쌍을 찾음

  - `a`와 `b`의 최대공약수와 최소공배수가 입력받은 `gcd`와 `lcm`과 같은지 검사

  - 이전에 가지고 있던 자연수의 쌍보다 합이 작은 경우 갱신