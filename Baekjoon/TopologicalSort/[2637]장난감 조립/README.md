...
| :-------- | :---------- | :--- | :--- | :-------- | :-------- |
| 1 초      | 128 MB      | 3700 | 1414 | 980       | 46.512%   |
...
| 예제 입력1                                                                              | 예제 출력1                     |
| :-------------------------------------------------------------------------------------- | :----------------------------- |
| 7<br/>8<br/>5 1 2<br/>5 2 2<br/>7 5 2<br/>6 5 2<br/>6 3 3<br/>6 4 4<br/>7 6 3<br/>7 4 5 | 1 16<br/>2 16<br/>3 9<br/>4 17 |
...
### 문제 접근
  ...
  - 위상 정렬을 하면서 각 중간 부품을 구성하는데 필요한 기본 부품의 수를 구함

    - `기본 부품 * 중간 부품의 수`

  - 기본 부품의 번호를 `res`에 담은 후 `res`를 sorting하여 기본 부품의 번호가 낮은 것 부터 `parts[res[i]]`로 접근하며 구해진 기본 부품의 필요 개수 출력