...
| :-------- | :---------- | :---- | :---- | :-------- | :-------- |
| 6 초      | 256 MB      | 39745 | 10011 | 6289      | 21.647%   |
...
| 예제 입력1                          | 예제 출력1        |
| :---------------------------------- | :---------------- |
| 3<br/>1234 3412<br/>1000 1<br/>1 16 | LL<br/>L<br/>DDDD |
...
### 문제 접근
  ...
  - 문제 자체는 어렵지 않으나 다수의 시간 초과 발생

  - `D`, `S`, `L`, `R` 연산 시, 굳이 `string`을 사용하지 않아도 가능

  - `string`을 지속적으로 재 할당하는데에도 많은 시간이 요구됨