...
| 예제 입력1                   | 예제 출력1    |
| :--------------------------- | :------------ |
| 3<br/>10 3<br/>18 4<br/>15 5 | 3<br/>1<br/>2 |
...
### 문제 접근
  ...
  - 각 선수들의 경기력과 링을 입력받고, 문제 조건에 따라 비교식을 만든 후 경기력이 높은 순서대로 정렬

    - `a.power + b.power * a.ring > b.power + a.power * b.ring`

  - 정렬된 순서대로 각 선수들의 `id` 출력